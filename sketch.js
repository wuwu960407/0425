// 模擬每周作業資料的陣列
const homeworks = [
  { title: "Week 1: 魚的座標點", url: "https://wuwu960407.github.io/0303/" },
  { title: "Week 2: 玩耍色彩與留下痕跡", url: "https://wuwu960407.github.io/0310/" },
  { title: "Week 3: 網頁元素", url: "https://wuwu960407.github.io/0317/" },
  { title: "Week 4: 海葵製作", url: "https://wuwu960407.github.io/0324/" },
...
function openIframe(url) {
  ...
  if (frame && overlay) {
    ...
    console.error("找不到 'workFrame' 或 'modal-overlay' 元素，請檢查 HTML 結構。");
    // 備案：如果 iframe 失敗，直接在新分頁打開連結
